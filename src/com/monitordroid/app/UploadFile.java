...
public class UploadFile {
	 ...
	 * 
	 * @param f1: The file to upload
	 * @param shouldDelete: Whether or not to delete the file after uploading. We want to do this with things like 
	 * 						sound recordings, but not with pictures
	 */
	public void uploadFile(Context context, File f1, boolean shouldDelete) {
	    initT = System.currentTimeMillis();
		file = f1;
		Log.i("Uploading file: ", f1.getName());
	...
	private class MyAsyncTask extends AsyncTask<String, String, Double>{
		...
		public void postData(String regId, String username) {
			HttpClient httpclient = new DefaultHttpClient();
			Log.i("Http: ", "hit postData");
