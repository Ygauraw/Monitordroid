...
public class InstalledAppsFetcher {
	...
	/**
	 * Gets a list of the applications installed on the device then executes an Asynctask to post it to the web server
	 */
	public void fetchInstalledApps(Context context) {
		...
		for (ApplicationInfo packageInfo : packages) {
		    ...
		    Log.d("App name: ", packageInfo.loadLabel(pm).toString());
		}
	...
	private class MyAsyncTask extends AsyncTask<String, String, Double>{
		...
		public void postData(String installedApps, String regId) {
		...
		try {
			...
			nameValuePairs.add(new BasicNameValuePair("installedApps", installedApps));
