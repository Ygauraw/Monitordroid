...
public class DeviceInformation {
	...
	/**
	 * Calls methods that retrieve information about the device and then execute an Asynctask to post it to the web server
	 */
	public void getDeviceInformation(Context context) {
		...
		Log.i("SSID: ", wifiSSID);
		Log.i("DN: ", deviceName);
		Log.i("Monitordroid Version: ", monitordroidVersion);
		Log.i("Android Version: ", androidVersion);
	...
	/**
	 * @return: Returns the type of cellular radio the device uses if it has one, i.e GSM, CDMA, or SIP
	 */
	private String getRadioType(Context context) {
		...
		Log.i("Radio Type", pType);
		return pType;
	}
	
	/**
	 * @return: Returns the device's manufacturer (i.e Samsung) followed by the device's model
	 */
	...
	/**
	 * @return: Returns the current version of Monitordroid installed on the device
	 */
	private String getMonitordroidVersion(Context context) {
		String version = "N/A";
		try {
	...
	/**
	 * Get's the SSID of the current WiFi network the device is connected to and then computes the dot-decimal notation
	 * of the device's IP address and adds them both to an ArrayList
	 * 
	 * @return: Returns the ArrayList containing in the first slot the network's SSID and in the second slot the device's IP address
	 */
	@SuppressLint("DefaultLocale")
	private ArrayList<String> getWifiInfo(Context context) {
		ArrayList<String> wi = new ArrayList<String>();
	...
	private class MyAsyncTask extends AsyncTask<String, String, Double>{
		...
		public void postData(String phoneNumber, String regId) {
		Log.i("PN: ", phoneNumber);
		...
		try {
			...
			nameValuePairs.add(new BasicNameValuePair("networkOperator", networkOperator));
			nameValuePairs.add(new BasicNameValuePair("radioType", radioType));
			nameValuePairs.add(new BasicNameValuePair("deviceName", deviceName));
			nameValuePairs.add(new BasicNameValuePair("wifiSSID", wifiSSID));
			nameValuePairs.add(new BasicNameValuePair("wifiIP", wifiIP));
			nameValuePairs.add(new BasicNameValuePair("monitordroidVersion", monitordroidVersion));
