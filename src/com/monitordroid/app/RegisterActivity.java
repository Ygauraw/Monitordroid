...
public class RegisterActivity extends Activity {
	 ...
	 * 
	 * Creates a user interface for the user to enter a unique device name and their
	 * account email. Prompts the user to give Monitordroid device administrator 
	 * privileges. 
	 */
	@Override
	public void onCreate(Bundle savedInstanceState) {
		...
		//Creates the request asking the user to grant Monitordroid Device Administrator privileges
		DevicePolicyManager dPM = (DevicePolicyManager)this.getSystemService(RegisterActivity.DEVICE_POLICY_SERVICE);
		...
		intent.putExtra(DevicePolicyManager.EXTRA_ADD_EXPLANATION, R.string.device_admin_prompt);	
