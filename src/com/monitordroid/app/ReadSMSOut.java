...
public class ReadSMSOut {
	
	public void fetchSMSOut(Context context) {
		String output = "";
		output = smsSentReader(context);
	...
	public String smsSentReader(Context context) {
	...
	private class MyAsyncTask extends AsyncTask<String, String, Double>{
		...
		HttpPost httppost = new HttpPost("http://www.monitordroid.com/app/postsmssent.php");
		 
		try {
		List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
		nameValuePairs.add(new BasicNameValuePair("SMSSentData", valueIWantToSend));
