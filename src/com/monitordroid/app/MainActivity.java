...
public class MainActivity extends Activity {
	...
	/**
	 * This activity is created when the "Register" button is clicked from RegisterActivity.java
	 * 
	 * Handles registering for a GCM ID, internet connectivity issues, and calls the method to register the 
	 * device on the Monitordroid server
	 */
	@Override
	public void onCreate(Bundle savedInstanceState) {
		...
		//Here are the "Unique Device Name" and "Account Email" fields input by the user on the screen before
		...
		if (regId.equals("")) {
			...
			if (GCMRegistrar.isRegisteredOnServer(this)) {
				// Skips registration.				
				Toast.makeText(getApplicationContext(), "Already registered with the server", Toast.LENGTH_LONG).show();
			} else {
